...
\onslide<3->
    ...
    \end{block}
\onslide<4->
    Let's jump right into doing some simulations
\end{frame}
...
\begin{frame}{Case 1, variation 1}{Change the thermal diffusivity}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \OpenfoamUnitSet{1,1,-2,0,0,0,0} is \unit{kg.m/s^2} $\implies$ unit of force
                \item \OpenfoamUnitSet{0,0,1,0,0,1,0} is \unit{A.s} $\implies$ unit of charge
                \item \OpenfoamUnitSet{1,2,2,-1,-1,0,0} is \unit{J/mol.K} $\implies$ unit of universal gas constant
            \end{itemize}
        \end{itemize}
        \item Try
        \begin{itemize}
...
\begin{frame}
    \begin{itemize}
        ...
        \item Blocks are created using a list of points $(p_0~p_1~p_2~p_3~p_4~p_5~p_6~p_7~p_8)$ ordered in a specific way
        \begin{enumerate}
    ...
    \begin{figure}
        \centering
        Suppose a block is defined using (0 1 2 3 4 5 6 7).\\
        Which one of these is wrong?\\[0.5em]
